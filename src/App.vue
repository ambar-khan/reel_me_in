<template>
 <div id='app' :style="{'background-image':'url(https://images.unsplash.com/photo-1536440136628-849c177e76a1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1525&q=80)'}">
  <header>
...
export default {
  ...
  methods: {
    getResult(genre, year, minrating, providor) {
      ...
      axios
        .get(
          "https://api.themoviedb.org/3/discover/movie?api_key=a4e8485214a389b8af6f13a3549063d5&with_cast=&with_genres=" +
            genre +
            "&year=" +
            year +
            "&vote_average.gte=" +
